...
export const ServiceCard: React.FC<ServiceCardProps> = ({ item, className, style }) => {
    return (
        <div className={`${styles.card} ${className || ''}`} style={style}>
            <div className={styles.card__content}>
                        <div className={styles.card__content_top}>
                            ...
                            {/* Desktop Button */}
                            <button className={`${styles.card__button} ${styles.card__button_desktop}`}>
                        ...
                        {/* Mobile Button */}
                        <button className={`${styles.card__button} ${styles.card__button_mobile}`}>
                            <p className={styles.card__button_text}>Book A Call</p>
                        </button>
                    </div>
        </div>
